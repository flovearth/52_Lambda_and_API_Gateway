...
def lambda_handler(event, context):
   destination_bucket_name = 'clarusway.destination.lambda-2170'
...
- Select S3 bucket named 'clarusway.source.lambda-2170'

- Upload files Guile.png and Honda.png

- Go to the S3 bucket named 'clarusway.destination.lambda-2170' and show the uploaded files to the source bucket.
